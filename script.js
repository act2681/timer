// ============ Configuration ============
const API_URL = ''; // จะใส่ทีหลังหลังสร้าง Cloudflare Worker
...
const quotes = [
  {
    text: "ความสำเร็จไม่ได้มาจากความบังเอิญ แต่มาจากความเสียสละ ขยันหมั่นเพียร ศึกษาเรียนรู้อย่างหนัก และเหนือสิ่งอื่นใด มันมาจากความรักในสิ่งที่กำลังทำหรือเรียนรู้อยู่นั่นเอง",
    author: "Pele"
  },
  {
  ...
  {
    text: "การศึกษาไม่ใช่การเรียนของคนในช่วงอายุหนึ่งเท่านั้น แต่การศึกษาคือการพัฒนาคุณภาพของคนทั้งมวล",
    author: "ภูมิปัญญาไทย"
  },
  {
